...
#ifndef GUARD_CODESMITHYIDE_BUILDFILES_TESTS_CMAKETESTSUITE_CMAKELISTSWRITERTESTS_HPP
#define GUARD_CODESMITHYIDE_BUILDFILES_TESTS_CMAKETESTSUITE_CMAKELISTSWRITERTESTS_HPP
